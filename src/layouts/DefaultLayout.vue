    ...
    <nav class="bg-white shadow-xl dark:bg-gray-800 sticky top-0 z-50">
      <div class="container mx-auto px-4 py-3 flex justify-between items-center">
        <a href="/" class="flex text-2xl font-bold text-blue-500 items-center item-center justify-center">
          ...
          />
          <!-- <div id="title_name"-->
            &nbsp;&nbsp;<router-link to="#" class="inline-block mt-1 text-xl font-bold tracking-wider bg-gradient-to-b from-green-900 to-gray-800 bg-clip-text text-transparent" style="font-family: sa;font-style: italic;">Predictive Maintenance System for Electric Motorcycles</router-link>
