      ...
      <header class="relative bg-white dark:bg-darker sticky top-0 z-50">
        <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
          ...
          <div class="flex">
            ...
            &nbsp;&nbsp;<router-link to="#" class="inline-block mt-1 text-2xl font-bold tracking-wider bg-gradient-to-b from-green-900 to-gray-800 bg-clip-text text-transparent" style="font-family: sa;">Predictive Maintenance System for Electric Motorcycles</router-link>
          </div>
          <!-- <div>
            <form action="#">
