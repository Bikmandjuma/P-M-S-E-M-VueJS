<template>
    <div class="flex items-center min-h-screen p-6 bg-gray-50 dark:bg-gray-900" id="login_container">
      <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden  mt-4 bg-white rounded-lg shadow-xl dark:bg-gray-800">
          ...
          <div class="flex items-center justify-center p-6  sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400"> <i class="fa fa-user"></i>&nbsp;Firstname</span>
                <input
                  v-model="formData.firstname"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="Enter firstname"
                />
                <p v-if="errors.firstname" class="text-sm text-red-500">{{ errors.firstname[0] }}</p>
              </label>

              <!-- Lastname Field -->
              <label class="block text-sm mt-4">
                <span class="text-gray-700 dark:text-gray-400"> <i class="fa fa-user"></i>&nbsp;Lastname</span>
                <input
                  v-model="formData.lastname"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="Enter lastname"
                />
                <p v-if="errors.lastname" class="text-sm text-red-500">{{ errors.lastname[0] }}</p>
              </label>
